...
namespace LS.SCO.Plugin.Adapter.Otter.MessageHandlers
{
    ...
    {
        public CancelProductHandler(OtterState otterState, OtterProtocolHandler otterProtocolHandler, OtterEventsManager manager, SamplePosAdapter samplePosAdapter) : 
